...
public class SelectedDayActivity extends FragmentActivity implements View.OnClickListener {
    ...
    private void initToolbar() {
        ...
        toolbar_iv_title.setText("请选择日历");
    ...
    public void sure() {
        ...
        if (num < 2) {
            ...
            Log.i(TAG, "sure: " + text);
            Log.i(TAG, "sure: " + "开始时间" + selectDays.get(0).getMonth() + "." + selectDays.get(0).getDay() + "---结束时间" + selectDays.get(selectDays.size() - 1).getMonth() + "." + selectDays.get(selectDays.size() - 1).getDay() + "共" + selectDays.size() + "天");
            //TODO  给上一个页面回传数据
            ToastFactory.getToast(SelectedDayActivity.this, "开始时间" + selectDays.get(0).getMonth() + "." + selectDays.get(0).getDay() + "---结束时间" + selectDays.get(selectDays.size() - 1).getMonth() + "." + selectDays.get(selectDays.size() - 1).getDay() + "共" + selectDays.size() + "天").show();
