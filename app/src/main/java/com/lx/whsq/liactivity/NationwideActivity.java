...
import com.lx.whsq.bean.JsonBean;
...
public class NationwideActivity extends BaseActivity implements View.OnClickListener{
    ...
    private TextView tv_submit,tv_site,tv_agreement;
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        mHandler.sendEmptyMessage(MSG_LOAD_DATA);
          ...
          actionDialog = new ActionDialog(NationwideActivity.this,"全国厂家总店申请协议","\n" +
                  "                            协议内容协议内容协议内容协议内容协议\n" +
                  "协议内容协议内容协议内容协议内容内容\n" +
                  "协议内容协议内容协议内容协议内容协议\n" +
                  "协议内容协议内容协议内容协议内容内容\n" +
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.tv_submit://提交申请
                Intent intent = new Intent(NationwideActivity.this,SelectActivity.class);
