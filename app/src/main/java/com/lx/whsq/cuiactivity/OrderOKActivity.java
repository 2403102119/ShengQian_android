...
public class OrderOKActivity extends BaseActivity implements View.OnClickListener {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MSG_LOAD_SUCCESS:
                    //Toast.makeText(RegisterCui1Activity.this, "解析成功", Toast.LENGTH_SHORT).show();
                    isLoaded = true;
                    break;
                case MSG_LOAD_FAILED:
                    //Toast.makeText(RegisterCui1Activity.this, "解析失败", Toast.LENGTH_SHORT).show();
                    break;
            }
        }
    };
    ...
    private void init() {
        ...
        final LinearLayout ViewDaiMai = findViewById(R.id.ViewDaiMai);
        final LinearLayout ViewDaiLi = findViewById(R.id.ViewDaiLi);
        final LinearLayout selectedAdd = findViewById(R.id.selectedAdd);
        textAdd = findViewById(R.id.TextAdd);
        selectedAdd.setOnClickListener(this);
        ...
        check1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ViewDaiMai.setVisibility(View.VISIBLE);
                }else {
                    ViewDaiMai.setVisibility(View.GONE);
                }
            }
        });
        ...
        check2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ...
                    ViewDaiMai.setVisibility(View.GONE);
                    ViewDaiLi.setVisibility(View.VISIBLE);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.selectedAdd:
                //ToastFactory.getToast(mContext, "点到了").show();
                //选择省市区
                if (isLoaded) {
                    showPickerView();
                }
