...
public class HotelAdapter extends RecyclerView.Adapter<HotelAdapter.MyHolder> {
    ...
    @Override
    public HotelAdapter.MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_hotel, parent, false);
        return new HotelAdapter.MyHolder(view);
    }

    @Override
    public void onBindViewHolder(HotelAdapter.MyHolder holder, final int position) {
...
//        }
    ...
    public void setOnItemClickListener(HotelAdapter.OnItemClickListener onItemClickListener) {
